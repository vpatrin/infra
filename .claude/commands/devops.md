...
- Read `docs/RFC-repo-reorg.md` if the question relates to the consolidation plan
- Read `docs/INFRASTRUCTURE.md` for server context
- Read `docs/PORT_ALLOCATION.md` for port assignments
...
7. Read `docs/RFC-repo-reorg.md` for the consolidation roadmap
...
- Reference the RFC (`docs/RFC-repo-reorg.md`) when the question intersects with the consolidation plan — don't give advice that contradicts the agreed direction.
